...
<template>
  <div p-4 flex flex-wrap>
    <div border="~ rounded gray-200 dark:gray-700" leading-normal mx-2 my-1 flex-nowrap>
      ...
      <input v-model="rRef" type="number" py-1 focus:outline-none pl-2 w-4rem max="255" min="0" leading-none rounded>
    </div>
    <div border="~ rounded gray-200 dark:gray-700" leading-normal mx-2 my-1 flex-nowrap>
      <span px-2 py-1 border="r gray-200 dark:gray-700">G</span>
      <input v-model="gRef" type="number" py-1 focus:outline-none pl-2 w-4rem max="255" min="0" leading-none rounded>
    </div>
    <div border="~ rounded gray-200 dark:gray-700" leading-normal mx-2 my-1 flex-nowrap>
      <span px-2 py-1 border="r gray-200 dark:gray-700">B</span>
      <input v-model="bRef" type="number" py-1 focus:outline-none pl-2 w-4rem max="255" min="0" leading-none rounded>
    </div>
    <ClickCopy
      :content="hex"
      :style="{ backgroundColor: hex, color: avg > 128 ? 'black' : 'white' }" rounded shadow px-4
      mx-2 py-1 my-1
    />
  </div>
</template>
