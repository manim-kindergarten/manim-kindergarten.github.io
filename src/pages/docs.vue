...
const data: CardData[] = [
  ...
  },
  {
    ...
    action: [
      ...
      { label: 'Download', icon: 'i-carbon-download', url: '/download/persuade2quit/manim%E4%BB%8E%E6%B2%A1%E5%85%A5%E9%97%A8%E5%88%B0%E8%A2%AB%E5%8A%9D%E9%80%80v1.0.pdf' }],
    previous: [
  ...
  },
  {
    ...
    action: [
      ...
      { label: 'Download', icon: 'i-carbon-download', url: '/download/manimgl-faq/manimgl%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98v1.2.pdf' }],
    previous: [
  ...
  },
  {
    ...
    action: [{ label: 'Go', icon: 'i-ri-links-fill', url: '/problems/new_usage' },
      { label: 'Download', icon: 'i-carbon-download', url: '/download/%E6%96%B0%E7%89%88manim%E7%94%A8%E6%B3%95%E5%8F%98%E5%8C%96v1.0.pdf' }],
  },
  {
    title: 'docs.structure-gl.title',
    description: 'docs.structure-gl.description',
    action: [
      { label: 'Download', icon: 'i-carbon-download', url: '/download/manimgl%E7%BB%93%E6%9E%84.pdf' }],
  },
  {
    title: 'docs.structure-cairo.title',
    description: 'docs.structure-cairo.description',
    action: [
      { label: 'Download', icon: 'i-carbon-download', url: '/download/manim%E7%BB%93%E6%9E%84.pdf' }],
  },
]
</script>
